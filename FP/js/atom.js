...
export class AtomModel {
    ...
    createElectrons() {
        ...
        electronConfigs.forEach((config, index) => {
            ...
            // Electron trails removed - they were causing visual artifacts
    ...
    highlightKind(kind, intensity = 1.0) {
        ...
        if (kind === 'proton' || kind === 'neutron') {
            ...
            // Keep electrons (trails removed)
            this.electrons.forEach(e => {
                keepSet.add(e);
                // Trails removed - no longer adding them to keepSet
            });
        }
